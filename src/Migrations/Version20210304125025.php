 ...
 */
final class Version20210304125025 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TEMPORARY TABLE __temp__Phone AS SELECT id, student_id, areaCode, number FROM Phone');
        $this->addSql('DROP TABLE Phone');
        $this->addSql('CREATE TABLE Phone (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, student_id INTEGER DEFAULT NULL, areaCode VARCHAR(2) NOT NULL COLLATE BINARY, number VARCHAR(11) NOT NULL COLLATE BINARY, CONSTRAINT FK_858EB8D9CB944F1A FOREIGN KEY (student_id) REFERENCES Student (id) NOT DEFERRABLE INITIALLY IMMEDIATE)');
        $this->addSql('INSERT INTO Phone (id, student_id, areaCode, number) SELECT id, student_id, areaCode, number FROM __temp__Phone');
